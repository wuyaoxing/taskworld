...
export class LoginForm extends React.PureComponent {
    ...
    getFullEmail = () => {
        ...
        return domain ? `${email}@${domain}` : null
    }
    ...
    renderEmailInputs = () => {
        ...
        const input = (
            <FormInput
                ...
                placeholder="email"
                onChange={e => { this.onFieldChange('emial', e.target.value)}}
    ...
    render() {
        return (
            <Form className="app-login-form ax-login-form" onSubmit={this.onSubmit}>
                {this.props.header}
